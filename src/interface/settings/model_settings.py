...
from src.connections.ollama import get_all_models, get_loaded_models, load_model, get_model_info
from src.utils.hardware import get_ram_info
from src.utils.save_settings import save_settings
from src.utils.toast import show_toast
from src.interface.components.selector import Treeview
...
def create_models_tab(globals, models_frame):
    ...
    model_selector = Treeview(globals,
                              models_frame,
                              all_models=lambda: get_all_models(globals, globals.ollama_chat_path))
