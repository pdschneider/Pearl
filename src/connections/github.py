...
def version_check(globals):
    ...
    if globals.beta:
        ...
        print(f"Beta updates not active. Using stable channel.")
    ...
    try:
        ...
        logging.error(f"AN error occurred while connecting to GitHub: {e}")
    ...
    try:
        ...
        if not linux_download_url and not windows_download_url:
