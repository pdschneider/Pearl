...
def create_about_tab(globals, about_frame):
    ...
    ctk.CTkLabel(
        ...
        f"Requirements:\n\n"
        f"- Ollama (with at least one LLM - "
        f"llama3.2:latest is currently the most compatible).\n"
        f"- Kokoro Fast-API for TTS integration.\n\n"
        f"Currently Supported on Linux and Windows.\n\n"
        f"Icon by Twoeliz\n\n"
        f"Disclaimer - Third-Party AI Models\n\n"
        f"Pearl integrates third-party artificial "
        f"intelligence models selected by the user. \n"
        f"The developer of this software is not responsible "
        f"for the accuracy, appropriateness, \n"
        f"legality, or safety of any output generated by "
        f"these AI models. All responses from \n"
        f"the AI are provided 'AS-IS' with no warrenties of any kind, "
        f"express or implied. \n"
        f"Selecting an AI model, configurings its safeguards, "
        f"and ensuring safe interaction are \n"
        f"entirely the user's responsibility. By using Pearl, "
        f"you acknowledge that any \n"
