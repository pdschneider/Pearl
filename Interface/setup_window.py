...
def create_setup_tab(globals, setup_tab):
    ...
    ctk.CTkLabel(ollama_frame,
                 justify="center",
                 text=f"To use Pearl's chat feature, "
                 f"Ollama must be installed.\n\n"
                 f"Head to https://ollama.com/download and "
                 f"follow the instructions for your OS.\n\n"
                 f"After installing Ollama, you'll need to also"
                 f"download a compatible model.\n\n"
                 f"There are many models to choose from,\n"
                 f"but the recommended starting model is "
                 f"llama3.2:latest.\n\n"
    ...
    ctk.CTkLabel(kokoro_frame,
                 justify="center",
                 text=f"For enhanced Text to Speech, "
                 f"you may install Kokoro (this is optional).\n\n"
                 f"Head to https://github.com/remsky/Kokoro-FastAPI "
                 f"and follow the instructions for your OS.\n\n"
                 f"After installing Kokoro, you'll need to also "
                 f"install and set up Docker.\n\n").pack(
    ...
    def refresh_button_states():
        ...
        if globals.ollama_active:
            ...
            globals.ollama_download_tooltip = ToolTip(
